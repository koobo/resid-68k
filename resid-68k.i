...
FIXP_MASK = $ffff
    ...
    EITEM   SAMPLING_METHOD_SAMPLE_FAST16
    ...
    EITEM   SAMPLING_METHOD_OVERSAMPLE2x16
    EITEM   SAMPLING_METHOD_OVERSAMPLE3x16
    EITEM   SAMPLING_METHOD_OVERSAMPLE4x16
